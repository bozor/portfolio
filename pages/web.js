  ...
  return (
    <React.Fragment>
      ...
      <article className="page-content">
        ...
        <Image src="../images/web/bp-desktop.jpg" alt='' />
        ...
        <Image src="../images/web/predict-desktop.jpg" alt='' />
        <div className="description">
        ...
        <Image src="../images/web/predict-mobile.jpg" alt='' />
        ...
        <Image src="../images/web/gfwd.jpg" alt='' />
        ...
        <a href="http://www.fianium.com" target="_blank" rel="noreferrer"><Image src="../images/web/fianium.jpg" alt='' /></a>
